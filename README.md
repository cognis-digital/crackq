...
[![PyPI](https://img.shields.io/pypi/v/cognis-crackq.svg)](https://pypi.org/project/cognis-crackq/)
[![CI](https://github.com/cognis-digital/crackq/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/crackq/actions)
...
```bash
crackq --version
crackq scan demos/                          # run against bundled demo
crackq scan demos/ --format sarif --out r.sarif --fail-on high
crackq mcp                                   # start as MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
- `demos/01-active-queue/` — see [`SCENARIO.md`](demos/01-active-queue/SCENARIO.md)
- `demos/02-clean-queue/` — see [`SCENARIO.md`](demos/02-clean-queue/SCENARIO.md)
- `demos/03-customer-engagement/` — see [`SCENARIO.md`](demos/03-customer-engagement/SCENARIO.md)
