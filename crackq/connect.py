"""Native cognis-connect emit for crackq — forward findings to any platform.

Maps crackq's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    crackq ... --format json | crackq-emit --to stix
    crackq-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
