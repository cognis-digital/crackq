#!/usr/bin/env sh
# Universal installer for crackq. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/crackq.git"
echo "Installing crackq ..."
